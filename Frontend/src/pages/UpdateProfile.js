...
const UpdateProfile = (data) => {
  ...
  const updatedValues = (data) => {
    ...
    axios.put("http://localhost:3000/updateuser", userdata, config).then(function (res) {
                ...
                <Card id="UserCard">
                  ...
                  <Card.Body>
                    <Form>
                      ...
                      >
                        <button className="UserProfileCngPassword bedit" type="submit">
                          Update Info
                        </button>
                      </div>
                      <div
